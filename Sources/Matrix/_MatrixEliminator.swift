...
public class _MatrixEliminator<R: EuclideanRing>: CustomStringConvertible {
    internal var target: ComputationalMatrix<R>
    internal var process: [EliminationStep<R>]
    ...
    internal func runTranpose(_ eliminator: _MatrixEliminator.Type) {
        transpose()
        let e = eliminator.init(target, debug: debug)
        e.run()
...
public final class RowEchelonEliminator<R: EuclideanRing>: _MatrixEliminator<R> {
...
public final class RowHermiteEliminator<R: EuclideanRing>: _MatrixEliminator<R> {
    internal var targetRow = 0
    internal var targetCol = 0
...
internal extension EliminationStep {
    internal var transpose: EliminationStep {
        switch self {
